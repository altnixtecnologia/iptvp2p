...
function setupChat() {
    ...
    const faqs = {
        'pagamento': { 
            ...
            a: 'Aceitamos PIX e Cartão de Crédito.' 
        },
        'como_funciona': { 
            q: 'Como funciona o serviço?', 
            a: 'Você recebe um usuário e senha para acessar nosso aplicativo exclusivo.' 
        },
        'teste': { 
            q: 'Posso fazer um teste grátis?', 
            a: 'Sim! Chame um de nossos atendentes no WhatsApp para solicitar.' 
        },
        'atendente': { 
            q: 'Falar com um atendente', 
            a: 'Claro! Clique aqui para ir para o WhatsApp: <a href="https://wa.me/5548991004780?text=Olá!%20Preciso%20de%20ajuda." target="_blank">Iniciar Conversa</a>' 
        }
    };
